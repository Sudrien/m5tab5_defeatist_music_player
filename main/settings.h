 ...
 * 5 to 3, and then to 6 once seen on the device: below 6 the picture is
 * too dark to be worth having. It is still not 0: a slider that can reach a black screen is a
 ...
 * as before.
 */
#define SETTINGS_BRIGHTNESS_MIN     (6)
